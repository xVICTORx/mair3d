    ...
    <?php if (count($productos) > 0): ?>
        ...
        <table>
            ...
            <tr>
                ...
                <td><?php echo $cliente->getCalleNumeroEnvio() . " " . $cliente->getColoniaEnvio() . ", " . $cliente->getMunicipioEnvio() . ", " . $cliente->getEstadoEnvio() . ", " . $cliente->getPaisEnvio() . " CP: " . $cliente->getCpEnvio(); ?></td>
            </tr>
        </table>
