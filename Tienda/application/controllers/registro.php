...
class Registro extends CI_Controller {
    ...
    public function nuevo() {
        $this->clienteService->save(null, $_POST["nombre"], $_POST["apPaterno"], $_POST["apMaterno"], $_POST["telefono"], $_POST["calle"], $_POST["colonia"], $_POST["municipio"], $_POST["estado"], $_POST["pais"], $_POST["cp"], $_POST["login"], md5($_POST["pass"]));
